module Codnar
  ...
  class Sunlight
    ...
    # element with the correct class (+sunlight+-+highlight+-_syntax_). The
    # actual highlighting is done in the HTML DOM using Javascript. Embedding
    # this Javascript into the final HTML should be done separately.
