...
module Codnar
  ...
  class TestFormatLines < Test::Unit::TestCase
    ...
    def test_process_unknown_lines
      ...
      ]).should == [ { "kind" => "html", "number" => 1, "line" => "<foo>", "html" => "<pre class='missing_formatter'>\n&lt;foo&gt;\n</pre>" } ]
    ...
    def test_process_code_lines
      ...
      ]).should == [ { "kind" => "html", "number" => 1, "line" => "<foo>", "html" => "<pre>\n&lt;foo&gt;\nbar\n</pre>" } ]
      @errors.should == []
    end
    ...
    def test_failed_formatter
      ...
      ]).should == [ { "kind" => "html", "number" => 1, "line" => "foo", "html" => "<pre class='failed_formatter'>\nfoo\n</pre>" } ]
